...
public class RecyclerviewAdapterHkbp extends RecyclerView.Adapter<RecyclerviewAdapterHkbp.ViewHolder>{
    ...
    public RecyclerviewAdapterHkbp(ArrayList<String> fototempatibadah, ArrayList<String> namatempatibadah, ArrayList<String> infotempatibadah, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.desain_layout_recyclerviewhkbp,parent,false);
       ViewHolder holder= new RecyclerviewAdapterHkbp.ViewHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.constraintLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(context, DetailActivityHKBP.class);
