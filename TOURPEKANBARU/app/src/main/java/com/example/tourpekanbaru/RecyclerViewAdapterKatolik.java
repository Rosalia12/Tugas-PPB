...
public class RecyclerViewAdapterKatolik extends RecyclerView.Adapter<RecyclerViewAdapterKatolik.ViewHolder>{
    ...
    public RecyclerViewAdapterKatolik(ArrayList<String> fototempatibadah, ArrayList<String> namatempatibadah, ArrayList<String> infotempatibadah, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.desain_layout_recyclerviewkatolik,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.constraintLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(context, DetailActivityKatolik.class);
